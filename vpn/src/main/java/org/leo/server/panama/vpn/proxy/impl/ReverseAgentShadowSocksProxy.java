 ...
 */
public class ReverseAgentShadowSocksProxy extends AbstractShadowSocksProxy {
    private final static Logger log = Logger.getLogger(ReverseAgentShadowSocksProxy.class);

    protected Wrapper agentWrapper;

    public ReverseAgentShadowSocksProxy(Channel clientChannel, Callback finish, String encryption, String password, NioEventLoopGroup eventLoopGroup, ShadowsocksRequestResolver requestResolver) {
